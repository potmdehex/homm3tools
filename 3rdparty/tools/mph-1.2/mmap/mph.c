...
usage(void)
{
	fprintf(stderr, "usage: mph [-a] [-m maxlen] [-l] [-d (2|3)] "
			 "[-c x.y] [-s|-S seed] foobar\n");
	exit(1);
}

void
readkeys(int argc, char **argv)
{
	int fd;
	extern int optind;
